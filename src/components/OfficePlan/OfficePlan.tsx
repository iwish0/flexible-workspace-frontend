...
export const OfficePlan: FunctionComponent = () => {
        ...
        <div>
            <svg width="640" height="480">
                <g className="layer">
                    ...
                    <rect onClick={handleClick} className={isAvailable ? 'green' : 'red'} fill="#00ff00" height="69" id="A1" stroke="#000000" width="75" x="39" y="28" />
